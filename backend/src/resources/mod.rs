use axum::{
    middleware::{ from_fn, from_fn_with_state}, routing::{delete, get, patch, post}, Router
};
use resources_service::{
    create_resource_service, delete_resource_service, get_resources_service, update_resource_service,
};
use crate::{middleware::{auth::auth_middleware, rotate_token::rotate_token_middleware}, utils::db::AppState};
